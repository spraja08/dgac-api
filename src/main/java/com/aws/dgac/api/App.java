...
//       String sql = "SELECT customerid, recordType, caller_number,called_party_number,cellId,startTime,endTime,cellId,charge,destinationCountryCode,balance_before,balance_after FROM sqlserver.dbo.transactions";
